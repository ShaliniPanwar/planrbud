    ...
    <div className="container bg-light">
      ...
      <ul className="to-do-list list-group list-group-flush">
        {items.map((item) => (
          ...
          <li className={`list-group-item list-group-item-info d-flex align-items-center justify-content-between ${item.completed ? "bg-success text-light" : "bg-info text-dark"}`} key={item.id}>
            <input
              type="checkbox"
